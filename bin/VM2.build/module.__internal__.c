...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_1__mro_entries_conversion(PyObject **python_pars) {
    ...
    branch_no_1:;
    {
        ...
        tmp_res = PyObject_HasAttr(tmp_expression_name_1, const_str_plain___mro_entries__);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_2_complex_call_helper_star_list(PyObject **python_pars) {
    ...
    branch_yes_1:;
    {
        ...
        tmp_res = PyObject_HasAttr(tmp_expression_name_1, const_str_plain___iter__);
        ...
        tmp_res = PyObject_HasAttr(tmp_expression_name_2, const_str_plain___getitem__);
    ...
    branch_no_2:;
    {
        ...
        tmp_tuple_element_1 = LOOKUP_ATTRIBUTE(tmp_expression_name_3, const_str_plain___name__);
...
NUITKA_LOCAL_MODULE PyObject *impl___internal__$$$function_3_get_callable_name_desc(PyObject **python_pars) {
    ...
    branch_yes_1:;
    {
        ...
        tmp_left_name_1 = LOOKUP_ATTRIBUTE(tmp_expression_name_1, const_str_plain___name__);
    ...
    branch_no_1:;
    {
        ...
        tmp_left_name_2 = LOOKUP_ATTRIBUTE(tmp_expression_name_2, const_str_plain___name__);
...
PyObject *modulecode___internal__(PyObject *module) {
    module___internal__ = module;
